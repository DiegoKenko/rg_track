...
const Color primaryColor = Color(0xFF1d2470);
const Color selectionCardColor = Color.fromARGB(255, 183, 187, 195);
const Color _textColor = Color.fromARGB(255, 132, 112, 112);
//const Color _textColorNight = Color.fromARGB(255, 183, 187, 195);
const Color _inputInfoColor = Color(0x33000000);
const Color inputErrorColor = Color(0xFFBF1120);
const Color deleteColor = Color(0xFFBF1120);
const Color secondaryColor = Color(0xFFE95054);
const Color activeColor = Color.fromARGB(255, 30, 174, 25);
